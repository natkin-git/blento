...
>
<div class="bg-[#A6CE39] text-base-950 inline-flex size-8 shrink-0 items-center justify-center rounded-full text-xs font-bold">
iD
</div>
<div class="min-w-0 flex-1">
<p class="text-base-500 dark:text-base-300 text-xs font-medium uppercase tracking-wide">ORCID</p>
<p class="text-base-950 dark:text-base-50 truncate text-base font-semibold">{id || 'ORCID iD'}</p>
</div>
